...
* Background
This is a recreation of the [[https://edwardtufte.github.io/tufte-css/][Tufte CSS homepage]] in org-mode using [[https://edwardtufte.github.io/tufte-css/][ox-tufte]]. The org file that generated this page is available [[https://github.com/tzcl/ox-tufte/blob/master/example.org][here]].
